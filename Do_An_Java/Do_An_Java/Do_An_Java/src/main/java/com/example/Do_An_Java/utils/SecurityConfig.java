package com.example.Do_An_Java.utils;

import com.example.Do_An_Java.services.OAuthService;
                                ...
                                .successHandler(
                                        (request, response,
                                         authentication) -> {
                                            ...
                                            userService.saveOauthUser(oidcUser.getEmail(), oidcUser.getName());response.sendRedirect("/");
                                        }
                                )
                                .permitAll()
